...
describe('kit bridge', () => {
  test('kitInstructionsToWeb3 converts a kit-v2 ix (boolean account shape) to web3.js', () => {
    ...
    expect(ix.keys[0].pubkey.equals(new PublicKey('So11111111111111111111111111111111111111112'))).toBe(true);
    expect(ix.keys[1].pubkey.equals(new PublicKey('Sysvar1nstructions1111111111111111111111111'))).toBe(true);
  ...
  test('kitInstructionsToWeb3 decodes string role shape (writableSigner / readonly)', () => {
    const kitIx = {
      programId: 'Hg3wRaydFtJhYrdvYrKECacpJYDsC9Px7yKmpncj2fhc',
      accounts: [
        { publicKey: 'So11111111111111111111111111111111111111112', role: 'writableSigner' },
        { publicKey: 'Sysvar1nstructions1111111111111111111111111', role: 'readonly' },
      ],
      data: [],
    };
    const [ix] = kitInstructionsToWeb3([kitIx]);
